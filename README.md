...
You can register a new user directly from the app’s **Register** page.
Alternatively, manually insert a user in MongoDB for testing:
...
1. Go to **Notes Section** → Add some content → Click **Generate Flowchart**
2. Go to **To-Do Section** → Add questions → Select multiple → Click **Generate Answers**
...
Prepify is designed to revolutionize how students learn by combining technology, AI, and simplicity.
It provides a single digital platform to manage study routines efficiently — anytime, anywhere. 🌟
